...
const (
	...
	serviceProjectURL  = "https://gitea.com"
	servicePackager    = "KN4CK3R <packager@gitea.com>"
)
		...
		t.Run(c, func(t *testing.T) {
			...
			t.Run("Valid", func(t *testing.T) {
				data := createPackage(c, map[string][]byte{
					".PKGINFO":        createPKGINFOContent(serviceName, serviceVersion),
					"/test/dummy.txt": {},
				})
