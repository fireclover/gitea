...
const (
	PropertyRepository   = "azurefunction.repository"
	PropertyArchitecture = "azurefunction.architecture"
	PropertySignature    = "azurefunction.signature"
	PropertyMetadata     = "azurefunction.metadata"
	PropertyBranch       = "azurefunction.branch"


	SettingKeyPrivate = "azurefunction.key.private"
	SettingKeyPublic  = "azurefunction.key.public"

	RepositoryPackage = "_azurefunction"
...
// ParsePackage parses an AzureFunction package file
